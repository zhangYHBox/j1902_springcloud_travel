...
public class ZxingTest {
    public static void main(String[] args) {
        try {
            ...
            QRReader(new File("E:/header-img-comment_02.png"));
    ...
    public static void QREncode() throws WriterException, IOException {
        String content = "https://home.firefoxchina.cn/";//二维码内容
//        String content = "http://www.baidu.com";//二维码内容
        ...
        MatrixToImageWriter.writeToPath(bitMatrix, format, new File("E:/header-img1.gif").toPath());// 输出原图片
         ...
         */
        BufferedImage bufferedImage = LogoMatrix(toBufferedImage(bitMatrix,matrixToImageConfig), new File("E:/header-img-comment_02.png"));
        //BufferedImage bufferedImage = LogoMatrix(toBufferedImage(bitMatrix), new File("D:\\logo.png"));
        ImageIO.write(bufferedImage, "gif", new File("E:/header-img.gif"));//输出带logo图片
